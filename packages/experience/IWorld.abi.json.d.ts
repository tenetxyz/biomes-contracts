declare const abi: [
  ...
  {
    "type": "function",
    "name": "experience__getBlockEntityDataWithExchangeChest",
    "inputs": [
      {
        "name": "entityId",
        "type": "bytes32",
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct BlockExperienceEntityDataWithExchangeChest",
        "components": [
          {
            "name": "worldEntityData",
            "type": "tuple",
  ...
  {
    "type": "function",
    "name": "experience__getBlocksEntityDataWithExchangeChest",
    "inputs": [
      {
        "name": "entityIds",
        "type": "bytes32[]",
