...
library DisplayUnregisterMsg {
   ...
   */
  function set(address experience, string memory unregisterMessage) internal {
   ...
   * @notice Set the full data using individual values.
   */
  function _set(address experience, string memory unregisterMessage) internal {
    bytes memory _staticData;
    EncodedLengths _encodedLengths = encodeLengths(unregisterMessage);
    bytes memory _dynamicData = encodeDynamic(unregisterMessage);
   ...
   */
  function set(IStore _store, address experience, string memory unregisterMessage) internal {
    bytes memory _staticData;
    EncodedLengths _encodedLengths = encodeLengths(unregisterMessage);
    bytes memory _dynamicData = encodeDynamic(unregisterMessage);
