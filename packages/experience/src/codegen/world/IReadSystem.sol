...
import { BlockExperienceEntityData, BlockExperienceEntityDataWithGateApprovals, BlockExperienceEntityDataWithExchanges, BlockExperienceEntityDataWithPipeApprovals } from "./../../Types.sol";
...
interface IReadSystem {
  ...
  function experience__getBlockEntityDataWithPipeApprovals(
    bytes32 entityId
  ) external view returns (BlockExperienceEntityDataWithPipeApprovals memory);
  ...
  function experience__getBlocksEntityDataWithPipeApprovals(
    bytes32[] memory entityIds
  ) external view returns (BlockExperienceEntityDataWithPipeApprovals[] memory);
}
