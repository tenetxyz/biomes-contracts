...
contract InitObjects {
  function initObjects() internal {
    ...
    ObjectTypeMetadata.set(
      ObjectTypes.OakLeaf,
      ObjectTypeMetadataData({ stackable: 99, maxInventorySlots: 0, mass: 1, energy: 0, canPassThrough: false })
    );
    ObjectTypeMetadata.set(
    ...
    // TODO: update energy to match the sum of the tree blocks
    ObjectTypeMetadata.set(
      ObjectTypes.OakSeed,
