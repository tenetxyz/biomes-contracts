...
contract TestScript is Script {
  function run(address worldAddress) external {
    ...
    testAddToInventoryCount(playerEntityId, PlayerObjectID, WoodenFrameMediumObjectID, 30);
