...
contract InitTerrainBlocksSystem is System {
  ...
  function initTerrainBlockObjectTypes() public {
    ...
    createTerrainBlock(ObjectTypes.OakLeaves, 100);
    createTerrainBlock(ObjectTypes.BirchLeaves, 100);
    createTerrainBlock(ObjectTypes.JungleLeaves, 100);
    createTerrainBlock(ObjectTypes.SakuraLeaves, 100);
    createTerrainBlock(ObjectTypes.AcaciaLeaves, 100);
    createTerrainBlock(ObjectTypes.SpruceLeaves, 100);
    createTerrainBlock(ObjectTypes.DarkOakLeaves, 100);
    ...
    createPassableTerrainBlock(ObjectTypes.Bamboo, 100);
    createPassableTerrainBlock(ObjectTypes.VinesBush, 100);
    createPassableTerrainBlock(ObjectTypes.IvyVines, 100);
