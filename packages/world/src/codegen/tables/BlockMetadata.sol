...
library BlockMetadata {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "BlockMetadata", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74620000000000000000000000000000426c6f636b4d65746164617461000000);
   ...
   * @notice Get owner.
   */
  function getOwner(bytes32 entityId) internal view returns (address owner) {
   ...
   * @notice Get owner.
   */
  function _getOwner(bytes32 entityId) internal view returns (address owner) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = entityId;
   ...
   */
  function getOwner(IStore _store, bytes32 entityId) internal view returns (address owner) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = entityId;
   ...
   * @notice Get owner.
   */
  function get(bytes32 entityId) internal view returns (address owner) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = entityId;
   ...
   * @notice Get owner.
   */
  function _get(bytes32 entityId) internal view returns (address owner) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = entityId;
   ...
   * @notice Get owner (using the specified store).
   */
  function get(IStore _store, bytes32 entityId) internal view returns (address owner) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = entityId;
   ...
   * @notice Set owner.
   */
  function setOwner(bytes32 entityId, address owner) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = entityId;
   ...
   * @notice Set owner.
   */
  function _setOwner(bytes32 entityId, address owner) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = entityId;
   ...
   */
  function setOwner(IStore _store, bytes32 entityId, address owner) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = entityId;
   ...
   * @notice Set owner.
   */
  function set(bytes32 entityId, address owner) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = entityId;
   ...
   * @notice Set owner.
   */
  function _set(bytes32 entityId, address owner) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = entityId;
   ...
   * @notice Set owner (using the specified store).
   */
  function set(IStore _store, bytes32 entityId, address owner) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = entityId;
