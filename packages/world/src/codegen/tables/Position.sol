...
library Position {
   ...
   * @notice Get position.
   */
  function getPosition(EntityId entityId) internal view returns (Vec3 position) {
   ...
   * @notice Get position.
   */
  function _getPosition(EntityId entityId) internal view returns (Vec3 position) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = EntityId.unwrap(entityId);
   ...
   * @notice Set position.
   */
  function setPosition(EntityId entityId, Vec3 position) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = EntityId.unwrap(entityId);
   ...
   * @notice Set position.
   */
  function _setPosition(EntityId entityId, Vec3 position) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = EntityId.unwrap(entityId);
