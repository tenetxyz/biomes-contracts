...
library ForceField {
   ...
   */
  function getTotalMassInside(EntityId entityId) internal view returns (uint128 totalMassInside) {
   ...
   * @notice Get totalMassInside.
   */
  function _getTotalMassInside(EntityId entityId) internal view returns (uint128 totalMassInside) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = EntityId.unwrap(entityId);
   ...
   */
  function setTotalMassInside(EntityId entityId, uint128 totalMassInside) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = EntityId.unwrap(entityId);
   ...
   * @notice Set totalMassInside.
   */
  function _setTotalMassInside(EntityId entityId, uint128 totalMassInside) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = EntityId.unwrap(entityId);
   ...
   */
  function set(EntityId entityId, uint128 totalMassInside, uint128 createdAt) internal {
    bytes memory _staticData = encodeStatic(totalMassInside, createdAt);
   ...
   * @notice Set the full data using individual values.
   */
  function _set(EntityId entityId, uint128 totalMassInside, uint128 createdAt) internal {
    bytes memory _staticData = encodeStatic(totalMassInside, createdAt);
   ...
   */
  function decodeStatic(bytes memory _blob) internal pure returns (uint128 totalMassInside, uint128 createdAt) {
   ...
   */
  function encodeStatic(uint128 totalMassInside, uint128 createdAt) internal pure returns (bytes memory) {
    return abi.encodePacked(totalMassInside, createdAt);
  }
