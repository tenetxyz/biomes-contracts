declare const abi: [
  ...
  {
    "type": "function",
    "name": "getPlayerEntityDataWithCommitment",
    "inputs": [
      {
        "name": "player",
        "type": "address",
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct PlayerEntityDataWithCommitment",
        "components": [
          {
            "name": "playerAddress",
            "type": "address",
  ...
  {
    "type": "function",
    "name": "getPlayersEntityDataWithCommitment",
    "inputs": [
      {
        "name": "players",
        "type": "address[]",
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct PipeTransferCommonContext",
        "components": [
          {
            "name": "targetCoord",
            "type": "tuple",
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct TransferCommonContext",
        "components": [
          {
            "name": "playerEntityId",
            "type": "bytes32",
