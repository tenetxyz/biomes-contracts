...
import { ClayObjectID, CobblestoneObjectID, CottonBlockObjectID } from "../../ObjectTypeIds.sol";
...
contract InitWorkbenchBlocksSystem is System {
    ...
    function initHandcraftedObjectTypes() public {
        ...
        createHandcraftedTool(toolObjectTypeId, mass, durability, damage);(WoodenPickObjectID, 16, 0, 0);
    ...
    function initHandcrafedRecipes() public { 
        ...
        createSingleInputRecipe(CottonObjectID, 4, CottonBlockObjectID, 1);
